...
import { CONTACT_EMAIL, CONTACT_WECHAT, FORM_RECIPIENT_EMAIL, RESPONSE_TIME } from '../data/contact';
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              ...
              <span className="text-gold font-medium text-xs tracking-wide">{emailCopied ? 'Copied!' : CONTACT_EMAIL}</span>
            </a>
            ...
            <div className="inline-flex items-center space-x-3 px-5 py-2 rounded-full border border-white/10 bg-dark-900 shadow-lg">
              ...
              <span className="text-gray-400 font-light text-[11px] tracking-[0.15em] uppercase">WeChat</span>
              <span
        ...
        <form onSubmit={handleSubmit} className="space-y-12 relative z-10 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
            ...
            <div className="relative group" ref={dropdownRef}>
              ...
              >
                <span className={inquiryType ? 'text-gold' : 'text-gray-600'}>{inquiryType}</span>
              ...
              >
                {inquiryOptions.map((option, index) => (
                  ...
                  >
                    <span className={inquiryType === option ? 'font-medium' : 'font-light'}>{option}</span>
                    {inquiryType === option && <Check className="w-4 h-4 text-gold" />}
                  </div>
                ))}
              </div>
            </div>
            ...
            {isSuccess ? (
              <div className="max-w-md mx-auto border border-gold bg-gold/5 px-8 py-7">
                ...
                <p className="text-gray-300 font-light text-sm leading-relaxed">
                  Thank you — your inquiry is on its way to Dr. Li, and you can expect a personal reply {RESPONSE_TIME}.
                </p>
                <p className="text-gray-500 font-light text-xs leading-relaxed mt-4">
                  If it&rsquo;s time-sensitive, email{' '}
                  <a href={`mailto:${CONTACT_EMAIL}`} className="text-gold hover:text-white transition-colors">
                    {CONTACT_EMAIL}
                  </a>{' '}
                  directly.
                </p>
              ...
              <>
                <p className="text-gray-500 font-light text-xs tracking-wide mb-6">Dr. Li replies personally {RESPONSE_TIME}.</p>
                <button
                  type="submit"
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <span>
                        AVAILABLE IN <span className="text-gold tracking-[0.25em] ml-1">{formatTime(cooldownTime)}</span>
                      </span>
                    </>
                  ) : (
