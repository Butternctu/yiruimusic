...
const Profile = () => {
  ...
  const memberSince = userProfile?.createdAt?.toDate ? formatDate(userProfile.createdAt.toDate()) : '—';
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-dark-900 pt-28 pb-24 relative flex flex-col">
        {/* Decorative elements */}
                        ...
                        className={`min-w-[160px] inline-flex items-center justify-center space-x-2 border px-8 py-3.5 text-xs uppercase tracking-widest transition-all duration-300 ${
                          saved
                            ...
                            : saving
                              ...
                              : 'border-gold text-gold hover:bg-gold hover:text-dark-900 shadow-[0_4_15px_rgba(197,160,89,0.1)]'
                        }`}
                      >
                        {saved ? (
                          <>
