    ...
    <>
      ...
      <section className="flex-1 bg-dark-900 pt-36 pb-8 relative flex flex-col overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex-1 flex flex-col z-10 min-h-0">
          ...
          {/* Chat Container */}
          <div className="flex-1 glass-card rounded-sm border border-white/10 flex flex-col overflow-hidden animate-fadeInUp shadow-2xl relative bg-white/[0.01] min-h-0" style={{ animationDelay: '100ms' }}>
